class CuratedAudiencesService
    AUDIENCES = [
        ...
        {name: "Marketers", subreddits: ["marketing", "digitalmarketing", "digital_marketing", "content_marketing", "askmarketing", "instagrammarketing", "marketingporn", "socialmediamarketing", "marketingresearch", "marketingauomation", "contentmarketing"]},    
